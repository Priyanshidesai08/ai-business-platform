...
const navItems = [
  ...
  { to: '/memory', label: 'Memory Center', icon: BrainCircuit, hint: 'Persist conversations and sessions' },
  { to: '/knowledge', label: 'Knowledge Hub', icon: LibraryBig, hint: 'Upload and search documents' },
  { to: '/prompts', label: 'Prompt Studio', icon: PencilLine, hint: 'Manage prompt versions and templates' },
  { to: '/workflow', label: 'Workflow Center', icon: Workflow, hint: 'Build executable business workflows' },
  { to: '/workflow/execution', label: 'Execution Dashboard', icon: Workflow, hint: 'Run workflows and inspect execution logs' },
  { to: '/workflow/builder', label: 'Workflow Builder', icon: Workflow, hint: 'Build workflows visually' },
  { to: '/workflow-builder', label: 'No-code Builder', icon: Workflow, hint: 'Build automations with nodes' },
  { to: '/analytics', label: 'Analytics', icon: TrendingUp, hint: 'Track performance and conversion' },
  { to: '/insights', label: 'Business Insights', icon: TrendingUp, hint: 'Forecast performance and trends' },
  { to: '/monitoring', label: 'Monitoring', icon: ShieldCheck, hint: 'Review telemetry and executive KPIs' },
